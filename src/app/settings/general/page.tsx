...
export default function GeneralSettingsPage() { 
  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        <h2 className="text-2xl font-bold tracking-tight font-headline">General Settings</h2> 
        <p className="text-muted-foreground">
          Manage general application settings like currency, language, and notifications.
        </p>
      </div>
